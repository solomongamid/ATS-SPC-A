...
<html>
   ...
   <body>
    ...
    <h5 style="color:rgb(246, 159, 17); font-family:verdana; text-align:center;"> You are arrive at <?php $time = date("m/d/y G.i:s<br>", time()); echo "$time" ?> </h5><br>
    		...
    		$OFFICETIME  = new DateTime('10:00:00');
          	$ABSENTIME = new DateTime('12:20:00');
   			 if ($CURRENTTIME  > $OFFICETIME && $CURRENTTIME < $ABSENTIME) {
      			 echo '<span style="color:rgb(255, 204, 51); font-size:160%; font-family:verdana;">You are late tody!</span>';
    			...
    			echo '<span style="color:rgb(218, 103, 11); font-size:160%; font-family:verdana; text-align:center;">You are absente today!</span>';
     		    ...
     		    echo '<span style="color:rgb(76, 175, 80); font-size:160%; font-family:verdana;">Good morning, Thank you for being on time!</span>';
  			 }
   ?>
   </div>
